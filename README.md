...
crescente. Il secondo è deliberatamente ambiguo.

1. **Esenzione IVA.** Serve un'aliquota a zero con causale obbligatoria (art. 15,
   fuori campo, non imponibile), perché in fattura la causale va stampata.
2. **Arrotondamento per riga o per documento.** Oggi si arrotonda riga per riga e poi
...
Il secondo serve a verificare il REQ-031: davanti a una scelta che la specifica non
